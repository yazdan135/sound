...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO songs (song_title, song_img, song_path, is_featured, type, date_added, author, song_category_id_FK, adder_admin) VALUES ('$title', '$img_name', '$song_name', $is_featured, 'video', '$current_date', '$author_name', '$cat_id', '$adder_admin')";
