    ...
    <div class="container-fluid">
        <div class="row mt-3">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Update Video</div>
                        <hr>
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="input-1">Featured:</label>
                                <div class="grp">
                                    <label>Yes</label>
                                    <input type="radio" <?php if($rows['is_featured'] == '1'){echo 'checked';}?> name="is_featured" value="yes">
                                    <label>No</label>
                                    <input type="radio" <?php if($rows['is_featured'] == '0'){echo 'checked';}?> name="is_featured" value="no">
                                </div>
                            </div>
                            <div class="form-group">
...
if (isset($_POST['submit'])) {
    ...
    $cat_id = $_POST['cat_id'];
    $is_featured = 0;
    if (isset($_POST['is_featured']) AND $_POST['is_featured'] == 'yes') {
        $is_featured = 1;
    }

    $sql = "UPDATE `songs` SET `song_title`='$title',`song_img`='$img_name',`song_path`='$song_name',`author`='$author_name',`song_category_id_FK`='$cat_id', `is_featured`=$is_featured WHERE id=$Id";
    $result = mysqli_query($conn, $sql);
}
?>