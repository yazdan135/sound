...
if (isset($_GET['search_input'])) {
    ...
    $sql_get_song = "SELECT 
                    ...
                    WHERE 
                        songs.type = 'song' AND songs.song_title LIKE '%$search_input%'
                    GROUP BY 
                        songs.id;";
    ...
    $sql_get_song = "SELECT 
                    ...
                    WHERE 
                        songs.type = 'song' AND songs.song_category_id_FK = '$category'
                    GROUP BY 
                        songs.id;";
} else {
    $sql_get_song = "SELECT 
...
$total_result = mysqli_num_rows($result_get_song);
            ...
            <div class="col-lg-12">
                <div class="trending__product">
                    ...
                    <div class="row">
                        ...
                        ?>
                            <a href="./listen_song.php?id=<?php echo $song_id; ?>" class="col-lg-3 col-md-4 col-sm-6">
